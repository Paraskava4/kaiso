...
const StrategicAnalysisAbout = () => {
    return (
        <section className="flex flex-col bg-[#fff] items-start gap-[10px] w-full px-4 sm:px-8 lg:px-[100px] xl:px-[200px] 2xl:px-[300px] py-[100px] md:py-[120px] lg:py-[150px]">
            {/* Wrapper */}
            <div className="flex flex-col lg:flex-row items-center gap-[52px] w-full">
                ...
                <div className="flex flex-col items-start gap-[20px]">
                    ...
                    <h2 className="mt-1 text-[26px] font-semibold leading-snug text-zinc-900">What is Strategic Growth Solutions</h2>
