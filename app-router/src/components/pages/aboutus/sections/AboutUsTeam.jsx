                ...
                <div className="max-w-[85%] mx-auto">
                    <div className="flex flex-col md:flex-row">
                        <div className="md:w-1/2 mb-10 md:mb-0 md:pr-20" style={{ marginTop: "10%" }}>
                            ...
                            <p className="text-black-700 mt-8 mb-7" style={{ fontSize: "14px" }}>
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <section className="py-12 px-4 sm:py-16 sm:px-6 md:py-20 md:px-8 lg:py-24 lg:px-16">
                <div className="max-w-[88%] mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
                    {/* Text Content */}
                    <div className="w-full max-w-xl text-center lg:text-left">
                        <span className="text-lg sm:text-xl md:text-2xl lg:text-3xl  font-medium ">Build Your Career with Kaiso</span>

                        <p className="text-xs sm:text-sm md:text-sm font-semibold mt-3 leading-snug">We're changing how Industries is made.</p>
