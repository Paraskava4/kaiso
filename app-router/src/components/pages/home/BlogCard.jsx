...
const BlogCard = ({ image, upperText = "Market, Technology Trends and Strategy Analysis", lowerText = "", blogId, type = "ARTICLE", blog }) => {
    ...
    return (
        <div className="relative group w-full cursor-pointer">
            ...
            {/* Card */}
            <div
                onClick={() => (blog?.blogId?.url ? redirect(`blog/${blog?.blogId?.url}`) : showErrorToast("please add url slug."))}
            ...
            >
                ...
                <div className="relative z-10 h-full p-8 flex flex-col">
                    ...
                    <button
                        ...
                        onClick={(e) => {
                            e.stopPropagation();
                            blog?.blogId?.url ? redirect(`blog/${blog?.blogId?.url}`) : showErrorToast("please add url slug.");
                        }}
                        tabIndex="-1"
                    >
