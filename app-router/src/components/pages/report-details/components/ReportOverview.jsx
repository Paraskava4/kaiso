...
const ReportOverview = (reportData) => {
    ...
    return (
        <div className="w-full bg-white rounded-lg shadow-sm" style={{ border: "1px solid lightgrey", marginTop: "-0.5%" }} data-section="sample">
            ...
            <div ref={contentRef} className="px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8 py-2 sm:py-3 md:py-4 lg:py-5 xl:py-6">
                <div className="prose prose-sm md:prose-base max-w-none">
                    {typeof renderContent() === "string" ? (
                        <div className="text-[13px] text-zinc-700 whitespace-pre-line">{renderContent()}</div>
                    ) : (
