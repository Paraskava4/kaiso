    ...
    return (
        <>
            ...
            <section className="w-full bg-[#F1F2F4] py-10 " style={{ margin: "0 auto" }}>
                ...
                <div className="relative mx-auto max-w-[81%]">
                    <div className="flex justify-center items-center gap-6 overflow-hidden">
                        {services.slice(currentIndex, currentIndex + visibleCards).map((s, i) => (
                            <div
                                key={currentIndex + i}
                                className="w-[220px] sm:w-[280px] md:w-[320px] h-[300px] sm:h-[350px] bg-[#FEFEFE] shadow-sm p-6 relative group hover:shadow-md transition-all duration-300 flex-shrink-0 transform hover:-translate-y-4"
                            >
                                <span
                                ...
                                <Image
                                    src={s.image}
                                    alt={s.title}
                                    className="pointer-events-none object-cover select-none w-full h-[200px] object-contain transform scale-110 filter transition-all duration-500"
                                    width={400}
                                    height={300}
                                    quality={100}
                                />
                    ...
                    <button
                        onClick={handlePrev}
                        className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-white shadow-md rounded-full p-2 hover:bg-gray-100 transition-colors"
                        style={{ zIndex: 10 }}
                    >
                        <ChevronLeft size={24} />
                    </button>
                    ...
                    <button
                        onClick={handleNext}
                        className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-white shadow-md rounded-full p-2 hover:bg-gray-100 transition-colors"
                        style={{ zIndex: 10 }}
                    >
