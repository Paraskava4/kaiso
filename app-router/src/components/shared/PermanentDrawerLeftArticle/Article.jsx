...
const Article = ({ setImageObj, errors }) => {
    ...
    // Convert File to base64 string for serializable Redux dispatch
                                                ...
                                                <input
                                                    ...
                                                    onChange={async (e) => {
                                                        ...
                                                        if (file) {
                                                            ...
                                                            // Convert to base64 for serializable Redux dispatch
                                                            const base64String = await fileToBase64(webpFile);
                                                            handleFieldChange(name, base64String, onChange);
                                                            setImageObj(webpFile); // Keep original file for upload
                                                        }
                                                    }}
                                                />
                                            </Button>
                                            {value && (value instanceof Blob || value instanceof File || (typeof value === 'string' && value.trim() !== '')) ? (
