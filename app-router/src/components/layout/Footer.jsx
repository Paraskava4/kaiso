...
const Footer = () => {
    ...
    const companyLinks = [
        ...
        { text: "Request for Consultation", href: "/consulting-services#contact-us" },
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-2">
                            <Image
                                ...
                                quality={100}
                            />
                            <Link href="https://maps.app.goo.gl/rHkPRUwuo2DkYc3U7" target="_blank" className="text-xs sm:text-sm lg:text-xs hover:underline">
