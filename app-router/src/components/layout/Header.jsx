                                ...
                                >
                                    <>
                                        ...
                                        {menuItems.map((item, index) => {
                                            const isNonNavigable = item.text === "Industries" || item.text === "Services";
                                            const NavComponent = isNonNavigable ? "div" : Link;
                                            const navProps = isNonNavigable ? {} : { href: getHref(item.text) };
