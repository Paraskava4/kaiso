 ...
 */
export default function CompetitivePositioningAnalysis() {
    return (
        <>
...
export async function generateMetadata() {
    try {
        ...
        const locale = "competitive-positioning-analysis";
        ...
        const canonicalUrl = `${BASE_URL}/competitive-positioning-analysis`;
        return {
            title: fallbackTitle,
