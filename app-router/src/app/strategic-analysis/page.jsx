import { StrategicAnalysisMarketInsightsPage } from "@/page-components";
import { BASE_URL } from "../../../config";
import { headers } from "next/headers";

/**
 * Strategic Analysis Market Insights Route Component
 *
 * This is the Next.js pages router page component for the strategic-analysis-market-insights route (/strategic-analysis-market-insights).
 */
export default function StrategicAnalysisMarketInsights() {
    return (
        <>
            <StrategicAnalysisMarketInsightsPage />
        </>
    );
}
...
export async function generateMetadata() {
    try {
        ...
        const seoItem = seoData?.data?.find((item) => item?.name === "Consulting Services")?.siteMenu?.find((sub) => sub?.url === "strategic-analysis") || {};
        ...
        const locale = "strategic-analysis";
