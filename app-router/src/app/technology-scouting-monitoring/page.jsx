 ...
 */
export default function TechnologyScouting() {
    return (
        <>
...
export async function generateMetadata() {
    try {
        ...
        const seoItem =
            seoData?.data?.find((item) => item?.name === "Consulting Services")?.siteMenu?.find((sub) => sub?.url === "technology-scouting-monitoring") || {};
        ...
        const locale = "technology-scouting-monitoring";
        ...
        const canonicalUrl = `${BASE_URL}/technology-scouting-monitoring`;
        return {
            title: fallbackTitle,
