...
// Mapping between frontend column IDs and backend field names for Inquiry Before Buy
...
const InquiryBeforeBuy = () => {
    ...
    function handleExport() {
        ...
        exportToExcel(selectedRows, columns, "inquiry_before_buy.xlsx");
    }
    ...
    const formatInquiryForInfoTable = (inquiry) => {
        ...
        // Inquiry Before Buy specific fields
        return [
            {
                label: "Inquiry ID",
    ...
    return (
        <div className="flex flex-col gap-4 w-full">
            {/* Page heading */}
            <PageHeader title="Inquiry Before Buy" rightContent={headerRight} />
            ...
            <DetailsModal
                ...
                title={(() => {
                    ...
                    if (reportTitle) {
                        ...
                        return `Inquiry Before Buy - ${truncatedTitle}`;
                    }
                    return "Inquiry Before Buy Details";
                })()}
...
export default InquiryBeforeBuy;
