 ...
 */
export default function PartnerIdentification() {
    return (
        <>
...
export async function generateMetadata() {
    ...
    try {
        ...
        const seoItem =
            seoData?.data?.find((item) => item?.name === "Consulting Services")?.siteMenu?.find((sub) => sub?.url === "partner-identification") || {};
        ...
        const locale = "partner-identification";
        ...
        const protocol = headersList.get("x-forwarded-proto") || (host?.includes("localhost") ? "http" : "https");
        const author = `Kaiso Research and Consulting, ${protocol}://${host}`;
        const canonicalUrl = `${BASE_URL}/partner-identification`;
        return {
            title: fallbackTitle,
