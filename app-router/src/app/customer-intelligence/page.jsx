...
export async function generateMetadata() {
    try {
        ...
        const seoItem =
            seoData?.data?.find((item) => item?.name === "Consulting Services")?.siteMenu?.find((sub) => sub?.url === "customer-intelligence") || {};
        ...
        const locale = "customer-intelligence";
        ...
        const canonicalUrl = `${BASE_URL}/customer-intelligence`;
        return {
            title: fallbackTitle,
