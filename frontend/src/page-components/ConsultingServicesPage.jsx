...
const ConsultingServicesBenefit = createLazyComponent(
    () => import("../components/pages/consulting-Services/ConsultingServicesBenefit"),
    { showTopLoader: false }
);
...
const ContactUs = createLazyComponent(
    () => import("../components/pages/home/ContactUs"),
    { showTopLoader: false }
);

const CommonBlog = createLazyComponent(
    () => import('@/components/shared/commanBlog'),
    { showTopLoader: false }
);
