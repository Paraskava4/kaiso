...
// Mapping between frontend column IDs and backend field names for Become Reseller
...
// Column definitions for Become Reseller Inquiries page
...
const BecomeReseller = () => {
    ...
    function handleExport() {
        ...
        exportToExcel(selectedRows, columns, "become_reseller.xlsx");
    }
    ...
    const handleStar = async (id) => {
        try {
            ...
            if (toggleInquiryLike.fulfilled.match(result)) {
                ...
                setFilteredRows((prev) => prev.map((row) => (row.inquiryNo === id ? { ...row, starred: !row.starred } : row)));
            } else {
                // Show error toast
    ...
    const formatInquiryForInfoTable = (inquiry) => {
        ...
        // Create an array of objects for InfoTable - reseller-specific fields
        return [
            {
                label: "Inquiry ID",
            ...
            { label: "Business Type", value: rawData.businessType || "-" },
            { label: "Website", value: rawData.website || "-" },
    ...
    return (
        <div className="flex flex-col gap-4 w-full">
            {/* Page heading */}
            <PageHeader title="Become a Reseller Inquiries" rightContent={headerRight} />
            ...
            <DetailsModal
                ...
                title="Become a Reseller Inquiry Details"
