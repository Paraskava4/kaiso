...
export default function dsisclaimer() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="ps-36 pt-10">
                <Breadcrumb
                    items={[
                        { label: "Disclaimer", href: "/dsisclaimer" },
                        ...(selectedName ? [{ label: selectedName, href: `/dsisclaimer/${selectedName.toLowerCase().replace(/\s+/g, "-")}` }] : []),
                    ]}
                />
            </div>
