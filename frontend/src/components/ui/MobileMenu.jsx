...
const MobileMenu = ({ isOpen, onClose, menuItems, navigationData }) => {
    ...
    const handleMenuItemClick = (menuText) => {
        if (!hasSubNavigation(menuText, navigationData)) {
            if (menuText === "About us" || menuText === "About Us") router.push("/aboutus");
            else if (menuText === "Blogs & News") router.push("/blog");
            else if (menuText === "Report Store") router.push("/report-store");
            onClose();
        } else {
            ...
            <div className={`mobile-menu ${isOpen ? "active" : ""}`}>
                ...
                >
                    ...
                    <div
                        ...
                        onClick={() =>
                            handleSearch({ url: `/report-store?search=${encodeURIComponent(searchValue)}` })
                        }
                    >
                                ...
                                <div className="mobile-submenu">
                                    {getSubNavigationData(item.text, navigationData)?.items?.map((subItem, subIndex) => (
                                        <div key={subIndex} className="mobile-submenu-section">
                                            <div className="mobile-submenu-title" onClick={() => handleSubMenuItemClick(subItem.title, item.text)}>
                                                {subItem.title}
                                            </div>
