...
export const CommanAudienceCard = ({ icon, title, description, isMobile }) => {
    return (
        <article
            className={`group relative py-2 flex-shrink-0 ${isMobile ? "w-[300px]" : "w-full"
            ...
            <div className="px-[7.9%]">
                <div className="flex justify-center items-center mb-6 md:mb-8 lg:mb-8">
                    <div className="text-center mb-4 md:mb-0 lg:mb-0">
                        <h2 className="text-xl md:text-2xl lg:text-[26px] font-semibold text-zinc-900">
                            {title}
                        </h2>
                        <p className="mt-3 text-sm md:text-base lg:text-base text-zinc-700 max-w-md md:max-w-lg lg:max-w-[900px]">
                            {subTitle}
                        </p>
                    </div>
                </div>
                <div className="relative flex items-center gap-4">
                    ...
                    <button
                        ...
                        className={`flex bg-white p-2 rounded-full shadow-md hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${isMobileView ? "absolute left-0 -ml-4 z-10 bg-opacity-90" : ""
                            }`}
                    ...
                    <button
                        onClick={handleNext}
                        className={`flex bg-white p-2 rounded-full shadow-md hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${isMobileView ? "absolute right-0 -mr-4 z-10 bg-opacity-90" : ""
                            }`}
