...
const PartnerIdentificationPageFaq = () => {
  return (
    <ResponsiveMarginContainer>
      <section className="flex flex-col ] md:flex-row gap-6 md:gap-10 items-center  p-4 sm:p-6 md:p-18 text-base sm:text-lg bg-orange-50 rounded-3xl text-zinc-900">
        {/* Left Image */}
