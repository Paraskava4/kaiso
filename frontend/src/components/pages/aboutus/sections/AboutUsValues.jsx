        ...
        <section className="py-8 sm:py-12 md:py-16 lg:py-24 px-4 sm:px-6 md:px-8 bg-white">
            ...
            >
                <div className="flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-10 md:mb-12 mt-6 sm:mt-8 md:mt-10">
                    ...
                    <div className="w-full md:w-1/2 flex justify-center items-center px-2 sm:px-4 md:px-6">
                        <div className="w-full max-w-[500px] sm:max-w-[550px] h-[250px] sm:h-[300px] md:h-[350px] lg:h-[400px] xl:h-[450px]">
                            <Image
                    ...
                    <div className="p-2 sm:p-3 md:p-4 flex flex-col items-center">
                        <div className="w-full max-w-[400px] sm:max-w-[460px]">
                            <Image
                                ...
                                priority
                            />
                            <p className="text-[#17306E] text-center my-1 sm:my-2 font-medium text-md sm:text-md">Our Mission</p>
                    ...
                    <div className="p-2 sm:p-3 md:p-4 flex flex-col items-center">
                        <div className="w-full max-w-[400px] sm:max-w-[460px]">
                            <Image
                                ...
                                priority
                            />
                            <p className="text-[#17306E] text-center my-1 sm:my-2 font-medium text-md sm:text-md">Our Vision</p>
                            <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-2 sm:mb-3">From Insight to Impact</h3>
                            <p className="text-black-600 text-sm sm:text-sm">
