...
function StrategicAnalysisPageHero() {
    ...
    return (
        <header className="relative flex flex-col w-full h-[calc(100dvh-100px)] overflow-hidden sm:overflow-auto md:overflow-auto" role="banner" aria-label="Strategic Analysis Hero Section">
            <Image
                width={0}
                height={0}
