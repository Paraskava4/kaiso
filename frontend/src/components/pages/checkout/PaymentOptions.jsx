...
const PayPalButtonsGroup = dynamic(() => import("@/components/shared/PayPalButtonsGrup"), { ssr: false });
    ...
    const AccordionArray = [
        {
            title: (
                <>
                    <Image src="/images/paypal.webp" width={0} height={0} className="w-100" />
                </>
            ),
            details: (
                <>
        ...
        },
        {
            title: (
                <>
                    <Image src={"/images/wire_transfer.webp"} width={0} height={0} className="w-100" />
                </>
            ),
            details: (
                <>
