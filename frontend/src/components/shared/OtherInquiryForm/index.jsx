                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                        ...
                        <div className="flex-1 w-full">
                            <input
                                ...
                                className={`w-full text-[14px] px-4 py-2 border ${errors.firstName ? "border-red-500" : "border-gray-300"
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                        ...
                        <div className="flex-1 w-full">
                            <input
                                ...
                                className={`w-full text-[14px] px-4 py-2 border ${errors.companyName ? "border-red-500" : "border-gray-300"
                                    } rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
                            />
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                        ...
                        <div className="flex-1 w-full">
                            <input
                                ...
                                className={`w-full text-[14px] px-4 py-2 border ${errors.businessEmail ? "border-red-500" : "border-gray-300"
                                    } rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
                            />
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                        ...
                        <div className="flex-1 w-full">
                            <input
                                ...
                                className={`w-full px-4 text-[14px] py-2 border ${errors.jobRole ? "border-red-500" : "border-gray-300"
                                    } rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
                            />
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <MuiTelInput
                                        ...
                                        helperText={errors.phoneInput?.message}
                                        onChange={(value, info) => {
                                            // keep the input controlled by full international value
                                            field.onChange(value);

                                            // sync derived fields used by backend payload and validation
                    ...
                    <div className="flex flex-col md:flex-row md:items-start gap-2 md:gap-4">
                        ...
                        <div className="flex-1 w-full">
                            <textarea
                                ...
                                className={`w-full px-4 text-[14px] py-2 border ${errors.message ? "border-red-500" : "border-gray-300"
                        ...
                        <div className="flex-1 w-full">
                            <div className="flex items-center gap-3 w-full">
                                <input
                                    ...
                                    className={`w-full sm:w-auto flex-grow px-4 text-[14px] py-2 border ${errors.captcha ? "border-red-500" : "border-gray-300"
                                        } rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
                                    autoComplete="off"
                                />
